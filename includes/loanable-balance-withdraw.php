<div id ="loanable-balance-withdraw-modal" class="modal fade" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
            <form id="withdraw-fund-form" method="POST" action="<?php $_SERVER['DOCUMENT_ROOT'];?>/catafa/actions/loanable_balance_withdraw.php">
                ...
                $(document).ready(function() {
                    $('#withdraw-submit').click(function() {
                        ...
                        if (withdrawAmount === '' || withdrawDescription === '') {
                            ...
                            $.ajax({
                                url: '../actions/loanable_balance_withdraw.php',
                                method: 'POST',
                                data: {
